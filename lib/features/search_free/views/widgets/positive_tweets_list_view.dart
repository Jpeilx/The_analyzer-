...
class PositiveFreeTweetsListView extends StatelessWidget {
  const PositiveFreeTweetsListView({super.key});
      ...
      builder: (context, state) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) => TweetBox(
            ...
            handle: 'xuser',
            timestamp:
                '${ FreeSearchResultCubit.get(context).tweetsSampleDataFree?.positiveTweets?[index].time}',
            content:
                '${FreeSearchResultCubit.get(context).tweetsSampleDataFree?.positiveTweets?[index].text}',
          ),
